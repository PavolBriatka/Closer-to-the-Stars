...
import com.example.pavol.closertostars.fragments.GalleryFragment;
import com.example.pavol.closertostars.fragments.MasterPictureFragment;
...
public class MainActivity extends AppCompatActivity implements CustomRecyclerViewAdapter.OnImageClickListener {
    ...
    public static int getCustomSize() {return customSquareSize;}
    public static String getLayoutTag() {return layoutTag;}
